...
from domain.meta_filehandler import MetaFilehandler
...
from domain.readme_reader import ReadmeReader
...
class Engine:
    ...
    def _get_next_book_record(self):
        return self._get_book_record(self.current_book_index + 1)
    ...
    def save_book_data(self, book_meta: BookMeta, current_stage: DescriptionStage):
        ...
        book_record: BookRecord = self.workstate.book_records[self.current_book_index]
        ...
        self.workstate.book_records[self.current_book_index] = book_record
    ...
    def get_current_book(self):
        meta = self._get_book_meta(self.current_book_index)
        rel_path = self._get_book_record(self.current_book_index).new_book_path
